...
Die Tabellen \ref{tab:routen} und \ref{tab:adminrouten} geben eine Übersicht der zur Verfügung stehenden Routen und die \acs{HTTP}-Methoden, mit welchen auf die Routen zugegriffen werden kann. 
...
Bei der Registrierung und Anmeldung eines Nutzers wird ein solcher Token ausgestellt, der bei anschließenden Anfragen an das Back-End mitgegeben werden muss.
...
Deshalb wird das Kommunikationsprotokoll \acs{HTTPS} verwendet.
