...
Dazu zählt beispielsweise das nach Anforderung A9 aus der Tabelle \ref{anf:GC} geforderte Anlegen und Löschen von Dozenten, welches mithilfe der Route \texttt{$\backslash$lecturers} durchgeführt wird. 
